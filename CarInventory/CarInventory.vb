...
Public Class frmCarInventory
    ...
    Private Sub btnEnter_Click(sender As Object, e As EventArgs) Handles btnEnter.Click
        ...
        If ValidUserInput() = True Then
            ...
            Else
                ...
                ' so get the car from the customers collection
    ...
    Private Function ValidUserInput() As Boolean 'Function to validate user input
        ...
        ' true if it passed validation or
    ...
    Private Sub lvwCarInformation_SelectedIndexChanged(sender As Object, e As EventArgs) Handles lvwCarInformation.SelectedIndexChanged
        ...
        cmbCarMake.Text = car.Make                 ' get the Car's make and sets to the combo box
        tbModelInput.Text = car.Model              ' get the Car's Model and set to the text box
        cmbCarYear.Text = car.Year                 ' get the Car's year and sets to the combo box
        tbPriceInput.Text = car.Price              ' get the Car's price and set too the text box
        chkNewCar.Checked = car.NewCar             ' get the new car boolean and set to the check box
